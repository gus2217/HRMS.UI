...
export const PERMISSIONS = {
  ...
  PATIENT_CONFIDENTIAL_VIEW: 'Patient.ConfidentialView',
  ...
  IDENTITY_USER_MANAGE_PERMISSIONS: 'Identity.User.ManagePermissions',
  IDENTITY_USER_RESET_PASSWORD: 'Identity.User.ResetPassword',
...
export const ROLE_PERMISSIONS: Record<SystemRole, Permission[]> = {
  ...
  Receptionist: [
    ...
    PERMISSIONS.QUEUE_VIEW,
    PERMISSIONS.APPOINTMENT_VIEW,
    PERMISSIONS.APPOINTMENT_REQUEST,
  ],
  LabTechnician: [
    PERMISSIONS.PATIENT_VIEW,
    PERMISSIONS.LABORATORY_ORDER,
  ...
  RecordsOfficer: [PERMISSIONS.PATIENT_VIEW, PERMISSIONS.PATIENT_UPDATE, PERMISSIONS.PATIENT_CONFIDENTIAL_VIEW],
  ITSupport: [
    ...
    PERMISSIONS.IDENTITY_USER_MANAGE_PERMISSIONS,
    PERMISSIONS.IDENTITY_USER_RESET_PASSWORD,
